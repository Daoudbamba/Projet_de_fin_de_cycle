...
// Récupérer toutes les propriétés à louer
$query = "SELECT * FROM propriete WHERE operation = 'louer'";
...
<body>
    ...
    <div class="inside-banner">
        <div class="container"> 
            <span class="pull-right"><a href="index.php">Accueil</a> / Louer</span>
                    ...
                    while($property = $result->fetch_assoc()) {
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="property">
                                ...
                                <a class="btn btn-primary" href="property-detail.php?id=' . htmlspecialchars($property["id"]) . '">Détails</a><br/><hr>
                            </div>
                        </div>';

                    }
                } else {
                    echo '<p>Aucune propriété disponible pour la location.</p>';
                }
                $connection->close();
                ?>
            </div>
